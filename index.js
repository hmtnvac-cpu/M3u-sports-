...
// ==================================================
// CHANNEL SVG SOURCE
// Sau đó weserv chuyển SVG này thành PNG
// ==================================================
...
function channelPoster(c) {

  return pngFromSvg(
    `${PUBLIC_BASE}/raw/channel/${c.id}.svg?v=91`
  );
}
...
function livePoster(match) {
  ...
  return pngFromSvg(
    `${PUBLIC_BASE}/raw/live/${match.id}.svg?v=91`
  );
}
...
app.listen(
  ...
  () => {
    ...
    console.log(
      `Live TV 9.1.0 running on port ${PORT}`
    );
